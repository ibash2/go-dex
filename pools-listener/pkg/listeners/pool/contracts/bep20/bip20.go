...
// AddRestricted is a paid mutator transaction binding the contract method 0x99f85c22.
//
// Solidity: function addRestricted(address[] restrictedAddresses) returns()
func (_Contracts *ContractsTransactor) AddRestricted(opts *bind.TransactOpts, restrictedAddresses []common.Address) (*types.Transaction, error) {
	return _Contracts.contract.Transact(opts, "addRestricted", restrictedAddresses)
}

// AddRestricted is a paid mutator transaction binding the contract method 0x99f85c22.
//
// Solidity: function addRestricted(address[] restrictedAddresses) returns()
func (_Contracts *ContractsSession) AddRestricted(restrictedAddresses []common.Address) (*types.Transaction, error) {
	return _Contracts.Contract.AddRestricted(&_Contracts.TransactOpts, restrictedAddresses)
}

// AddRestricted is a paid mutator transaction binding the contract method 0x99f85c22.
//
// Solidity: function addRestricted(address[] restrictedAddresses) returns()
func (_Contracts *ContractsTransactorSession) AddRestricted(restrictedAddresses []common.Address) (*types.Transaction, error) {
	return _Contracts.Contract.AddRestricted(&_Contracts.TransactOpts, restrictedAddresses)
}
